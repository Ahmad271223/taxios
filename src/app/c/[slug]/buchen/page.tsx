  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-ink-50 to-ink-100">
      ...
      <section className="mx-auto max-w-2xl px-5 py-8">
        <span className="chip bg-brand-100 text-brand-700">🚕 Sofort</span>
        <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-ink-900">Taxi jetzt bestellen</h1>
        <p className="mt-1.5 text-ink-600">Geben Sie Ihre Fahrt ein – wir finden den nächsten freien Fahrer.</p>
